...
namespace DotNetCore20Sample
{
    /// <summary>
    /// See https://github.com/benaadams/Ben.Demystifier/blob/master/sample/StackTrace/Program.cs
    /// </summary>
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // Must pass a message (even if empty) otherwise NLog will render the original exception
                // stack trace for ${message} so you'll get the original stack trace followed by the
                // demystified stack trace for ${exception}
